...
#  if defined(DFTFE_WITH_DEVICE)
  ...
  computeAuxProjectedDensityMatrixFromPSI(
    ...
    const unsigned int         quadratureIndex,
    const std::vector<double> &kPointWeights,
    AuxDensityMatrix<dftfe::utils::MemorySpace::DEVICE> &         auxDensityMatrixRepresentation,
    const MPI_Comm &           mpiCommParent,
    const MPI_Comm &           domainComm,
    const MPI_Comm &           interpoolcomm,
    const MPI_Comm &           interBandGroupComm,
...
#  endif
  ...
  computeAuxProjectedDensityMatrixFromPSI(
    ...
    const unsigned int         quadratureIndex,
    const std::vector<double> &kPointWeights,
    AuxDensityMatrix<dftfe::utils::MemorySpace::HOST> &         auxDensityMatrixRepresentation,
    const MPI_Comm &           mpiCommParent,
    const MPI_Comm &           domainComm,
    const MPI_Comm &           interpoolcomm,
    const MPI_Comm &           interBandGroupComm,
